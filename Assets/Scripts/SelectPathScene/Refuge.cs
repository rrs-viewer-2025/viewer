...
public class Refuge : MonoBehaviour
{
    ...
    public Dictionary<int, RefugeNode> refugeGraph = new Dictionary<int, RefugeNode>();
    ...
    // JSONを読み込んで建物を描画
    public void LoadAndDrawBuilding()
    {
        ...
        if (File.Exists(filePath))
        {
            ...
            foreach (var entity in entities)
            {
                ...
                RefugeNode node = new RefugeNode();
                if (urn == 4357) // 避難所
                {
                ...
                refugeGraph[node.EntityID] = node;
            }
        }
        else
        {
    ...
    public Dictionary<int, RefugeNode> getRefugeGraph()
    {
        return refugeGraph;
    }
}
